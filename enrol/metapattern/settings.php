...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtime('enrol_metapattern/cronstarthour', 'cronstartminute', get_string('statsruntimestart', 'admin'), get_string('configstatsruntimestart', 'admin'), array('h' => 3, 'm' => 0)));
