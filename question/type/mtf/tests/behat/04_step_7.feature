...
Feature: Step 7
  ...
  # Images and so on are displayed and work.
    ...
    And I output "[MTF - TESTCASE 7 - begin]"
  ...
  # Add video to question stem
    ...
    And I attach file "/var/www/moodle/question/type/mtf/tests/media/testvideo1.mp4" to "input[name='repo_upload_file']"
  ...
  # Add image to feedback
    ...
    And I press "Browse repositories..."
    And I click on "URL downloader" "link" in the ".fp-repo-area" "css_element"
    And I set the field "fileurl" to "http://127.0.0.1/question/type/mtf/tests/media/testimage3.png"
    And I press "Download"
  ...
  # Preview
    ...
    And I output "[MTF - TESTCASE 7 - end]"
