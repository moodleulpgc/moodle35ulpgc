...
$string['delayedattemptlock'] = 'Delayed access';
...
A countdown period is started (random up to 10 min). When the countdown ends the start attempt button is re-enabled and teh studenst can initiate the quiz attempt. ';
