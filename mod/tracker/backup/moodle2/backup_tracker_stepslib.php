...
class backup_tracker_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $issue = new backup_nested_element('issue', array('id'), array(
            'trackerid', 'summary', 'description', 'descriptionformat', 'datereported', 'reportedby', 'status', 'assignedto', 'bywhomid', 'timeassigned', 'resolution', 'resolutionformat', 'resolutionpriority', 'downlink', 'uplink', 'usermodified', 'resolvermodified', 'userlastseen'));
