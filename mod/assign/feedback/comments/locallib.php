...
class assign_feedback_comments extends assign_feedback_plugin {
    ...
    public function is_feedback_modified(stdClass $grade, stdClass $data) {
        ...
        if (isset($data->assignfeedbackcomments_editor['itemid'])) {
            ...
            $formtext = $this->rewrite_feedback_comments_urls($formtext, $data->assignfeedbackcomments_editor['itemid']);
    ...
    public function save(stdClass $grade, stdClass $data) {
        ...
        // ecastro ULPGC
            $formtext = file_rewrite_urls_to_pluginfile($data->assignfeedbackcomments, $grade->id);
            // file_rewrite_pluginfile_urls($text, $file, $contextid, $component, $filearea, $itemid, array $options=null)
            $data->assignfeedbackcomments = $this->rewrite_feedback_comments_urls($formtext, $grade->id);
        // ecastro ULPGC
