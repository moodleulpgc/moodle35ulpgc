        ...
        if ($data = $this->moodleform->get_data()) {
            ...
            foreach ($_POST as $varname => $value) {
                ...
                if (strstr($varname, '@@') != false) {
                    ...
                    $setting->name = $name[0];
                    if(isset($sitesettings[$setting->plugin][$setting->name]) && $sitesettings[$setting->plugin][$setting->name]) { // ecastro ULPGC
                    ...
                    if (isset($sitesettings[$setting->plugin][$setting->name]) && $sitesettings[$setting->plugin][$setting->name] && $attributes = $sitesettings[$setting->plugin][$setting->name]->get_attributes_values()) { // ecastro ULPFC
