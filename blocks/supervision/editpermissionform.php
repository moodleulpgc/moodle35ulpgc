...
class supervision_editpermission_form extends moodleform {
    ...
    function definition() {
       ...
       if($hiddens['department']) {
            ...
            $itemlist =  make_categories_options();
        ...
        $instanceel = &$mform->addElement('select', 'instance', get_string('itemname', 'block_supervision'), $itemlist );
        ...
        $userel = &$mform->addElement('select', 'userid', get_string('supervisor', 'block_supervision'), $userlist);
        ...
        // review warning
        $mform->addElement('selectyesno', 'review', get_string('review', 'block_supervision'));
        ...
        $select = &$mform->addElement('select', 'warnings', get_string('supervisionwarnings', 'block_supervision'), $warnings );
        ...
        if($canmanage) {
            $mform->addElement('selectyesno', 'adduser', get_string('addusersetting', 'block_supervision'));
        ...
        $mform->addElement('text', 'timeduration', get_string('holidayduration', 'block_supervision'), array('size'=>'4'));
        $mform->setType('timeduration', PARAM_INT);
        $mform->setDefault('timeduration', '1');

        $mform->addElement('text', 'scope', get_string('holidayscope', 'block_supervision'), array('size'=>'10'));
        ...
        */
        ...
        $this->add_action_buttons(true, get_string('save', 'block_supervision'));
    }
}
